...
\subsection{Mental Health and Neurodiversity}

Social Anxiety Disorder (SAD) is characterised as a fear of social situations, often due to the risk of embarrassing oneself or being judged \cite{alomari_2022_social}.
SAD is not restricted to physical interactions, but can also include online/asynchronous interaction, which can feel debilitating to those afflicted.
Studies indicate that students who leave education prematurely are much more likely to be diagnosed with general social phobia \cite{vanameringen_2003_the}.
Despite common misconceptions, time spent online does not correlate with social anxiety \cite{prizantpassal_2016_social}.
For those with SAD, the use of online technologies actually helps to increase feelings of comfort and ease anxieties \cite{prizantpassal_2016_social}.

\textcolor{cyan}{\textit{Students with ADHD and/or Autism tend to struggle in higher education \cite{clouder_2020_neurodiversity}}}

\textcolor{magenta}{\textit{Discuss the rising impact of Social Anxiety due to COVID and how easy it is to access everything onilne. Also discuss personal difficulties with this.}}

\textcolor{magenta}{\textit{Discuss how some students have learning difficulties which can make university more difficult}}
...
\subsection{Lack of Community}

\textcolor{magenta}{\textit{Talk about how learning platforms don't offer students a proper space to communicate with one another. (Some modules have tried discord, but it is not uni-led)}}

\section{Proposed Solutions}

\subsection{Gamification}

\textcolor{magenta}{\textit{Discuss features of games which may be enticing to users. Talk about how unlocking items feels productive (maybe find a source for this?)}}

\subsection{Social Features}

\textcolor{cyan}{\textit{As shown in form results, most test users use some form of social media.}}
...
\textcolor{magenta}{\textit{Talk about how popular discord has become, and what features it offers users to customise}}
